...
class Cvut(models.Model):
    ...
    instituce = models.CharField(db_column='Instituce', max_length=10, blank=True,
                                 null=True)  # Field name made lowercase.
    fond = models.CharField(db_column='Fond', max_length=50, blank=True, null=True)  # Field name made lowercase.
    inventarni_cislo = models.CharField(db_column='Inventarni_cislo', max_length=20, blank=True,
                                        null=True)  # Field name made lowercase.
    signatura = models.CharField(db_column='Signatura', max_length=50, blank=True,
                                 null=True)  # Field name made lowercase.
    inkrement = models.CharField(db_column='Inkrement', max_length=20, blank=True,
                                 null=True)  # Field name made lowercase.
    karton_ulozeni = models.CharField(db_column='Karton_ulozeni', max_length=100, blank=True,
                                      null=True)  # Field name made lowercase.
    lokalita = models.CharField(db_column='Lokalita', max_length=100, blank=True,
                                null=True)  # Field name made lowercase.
    puv_nazev = models.CharField(db_column='Puv_nazev', max_length=100, blank=True,
                                 null=True)  # Field name made lowercase.
    ...
    zakladni_klasifikace = models.CharField(db_column='Zakladni_klasifikace', max_length=50, blank=True,
                                            null=True)  # Field name made lowercase.
    objekt_ucel = models.CharField(db_column='Objekt_ucel', max_length=50, blank=True,
                                   null=True)  # Field name made lowercase.
    objekt_material = models.CharField(db_column='Objekt_material', max_length=50, blank=True,
                                       null=True)  # Field name made lowercase.
    narodopisna_oblast = models.CharField(db_column='Narodopisna_oblast', max_length=50, blank=True,
                                          null=True)  # Field name made lowercase.
    typ_domu = models.CharField(db_column='Typ_domu', max_length=50, blank=True,
                                null=True)  # Field name made lowercase.
    popis_objektu = models.TextField(db_column='Popis_objektu', blank=True, null=True)  # Field name made lowercase.
    poznamka_doplnek = models.TextField(db_column='Poznamka_doplnek', blank=True,
                                        null=True)  # Field name made lowercase.
    evid_jednotka = models.CharField(db_column='Evid_jednotka', max_length=100, blank=True,
                                     null=True)  # Field name made lowercase.
    ...
    datum_vzniku = models.CharField(db_column='Datum_vzniku', max_length=100, blank=True,
                                    null=True)  # Field name made lowercase.
    ...
    zpracovatel_zaznamu = models.CharField(db_column='Zpracovatel_zaznamu', max_length=50, blank=True,
                                           null=True)  # Field name made lowercase.
    datum_zprac = models.CharField(db_column='Datum_zprac', max_length=50, blank=True,
                                   null=True)  # Field name made lowercase.
    ...
    negativ_rozmer_mat = models.CharField(db_column='Negativ_rozmer_mat', max_length=50, blank=True,
                                          null=True)  # Field name made lowercase.
    poznamka_dokument = models.TextField(db_column='Poznamka_dokument', blank=True,
                                         null=True)  # Field name made lowercase.
